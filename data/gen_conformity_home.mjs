...
// Exact home content from Celestial-Agent-Nexus seed.ts (EN 99-249, NL 485-635),
// with CTA hrefs adapted to THIS app's real routes (per approved comparison).
const REGS = ["Cyber Resilience Act","EU AI Act","Machinery Regulation 2023/1230","IEC 62443","NIS2 Directive","Radio Equipment Directive"];
const en = {
  hero: { eyebrow:"Compliance, engineered", title:"Four regulations. One evidence system.",
    ...
    primaryCta:{label:"Explore the platform",href:"/conformity-platform"}, secondaryCta:{label:"See our approach",href:"/industrial-operations"},
    bullets:["Overlap mapped once, reused everywhere","Audit-ready evidence, always current","Engineers stay in their tools"] },
  logoWall: { title:"Built for the regulations reshaping industrial products", logos:REGS },
  stats: [
  ...
  featureGrid: { eyebrow:"The platform", title:"Everything a conformity dossier needs, in one place",
  ...
  problem: { eyebrow:"The problem", title:"The regulations overlap. Your tooling doesn't.",
    ...
    bullets:["Duplicate requirements re-documented per framework","Evidence that goes stale the moment code ships","No single view of what is actually covered"],
    cta:{label:"See how we fix it",href:"/industrial-operations"} },
  shift: { eyebrow:"The shift", title:"Prove conformity as a by-product of building",
    ...
    bullets:["One control satisfies many regulations","Engineers contribute evidence without leaving their tools","Leadership sees conformity status at a glance"],
    cta:{label:"Explore the platform",href:"/conformity-platform"} },
  comparison: { eyebrow:"Why OXOT", title:"One system versus four silos",
    ...
    rows:[
      {label:"Requirement mapping",left:"Repeated per regulation",right:true},
      {label:"Evidence freshness",left:"Manual, drifts quickly",right:true},
      {label:"Cross-regulation reuse",left:"",right:true},
      {label:"Audit preparation",left:"Quarter-long scramble",right:true},
      {label:"Expert guidance",left:"Ad-hoc consultants",right:true},
      {label:"Real-time coverage view",left:"",right:true} ] },
  steps: { eyebrow:"How it works", title:"From scattered documents to a living dossier",
    steps:[
  ...
  quote: { quote:"We used to treat every regulation as a separate fire drill. With OXOT the evidence writes itself once and answers all of them.", author:"Head of Product Security", role:"Industrial automation vendor" },
  faq: { eyebrow:"Questions", title:"What teams ask before starting",
    items:[
  ...
  cta: { title:"See your conformity status in one view", subtitle:"Book a walkthrough and we'll map your products to the regulations that matter.",
    primaryCta:{label:"Talk to OXOT",href:"/contact"}, secondaryCta:{label:"Explore the platform",href:"/conformity-platform"} }
};
const nl = {
  hero: { eyebrow:"Conformiteit, doordacht", title:"Vier regelgevingen. Eén bewijssysteem.",
    ...
    primaryCta:{label:"Ontdek het platform",href:"/conformity-platform"}, secondaryCta:{label:"Bekijk onze aanpak",href:"/industrial-operations"},
    bullets:["Overlap eenmaal in kaart, overal hergebruikt","Auditklaar bewijs, altijd actueel","Ingenieurs blijven in hun tools"] },
  logoWall: { title:"Gebouwd voor de regelgeving die industriële producten hervormt", logos:REGS },
  stats: [
  ...
  featureGrid: { eyebrow:"Het platform", title:"Alles wat een conformiteitsdossier nodig heeft, op één plek",
  ...
  problem: { eyebrow:"Het probleem", title:"De regelgeving overlapt. Uw tooling niet.",
    ...
    bullets:["Dubbele eisen per raamwerk opnieuw gedocumenteerd","Bewijs dat veroudert zodra code live gaat","Geen enkel overzicht van wat werkelijk gedekt is"],
    cta:{label:"Zie hoe wij dit oplossen",href:"/industrial-operations"} },
  shift: { eyebrow:"De omslag", title:"Toon conformiteit als bijproduct van het bouwen",
    ...
    bullets:["Eén controle voldoet aan meerdere regelgevingen","Ingenieurs leveren bewijs zonder hun tools te verlaten","Leiding ziet de conformiteitsstatus in één oogopslag"],
    cta:{label:"Ontdek het platform",href:"/conformity-platform"} },
  comparison: { eyebrow:"Waarom OXOT", title:"Eén systeem versus vier silo's",
    ...
    rows:[
      {label:"Eisen in kaart brengen",left:"Per regelgeving herhaald",right:true},
      {label:"Actualiteit van bewijs",left:"Handmatig, verschuift snel",right:true},
      {label:"Hergebruik over regelgevingen",left:"",right:true},
      {label:"Auditvoorbereiding",left:"Kwartaal lang haasten",right:true},
      {label:"Expertbegeleiding",left:"Ad-hoc consultants",right:true},
      {label:"Realtime dekkingsoverzicht",left:"",right:true} ] },
  steps: { eyebrow:"Hoe het werkt", title:"Van verspreide documenten naar een levend dossier",
    steps:[
  ...
  quote: { quote:"Vroeger was elke regelgeving een aparte brandoefening. Met OXOT schrijft het bewijs zich eenmaal en beantwoordt het ze allemaal.", author:"Hoofd Productbeveiliging", role:"Leverancier industriële automatisering" },
  faq: { eyebrow:"Vragen", title:"Wat teams vragen voordat ze starten",
    items:[
  ...
  cta: { title:"Zie uw conformiteitsstatus in één overzicht", subtitle:"Boek een rondleiding en we koppelen uw producten aan de relevante regelgeving.",
    primaryCta:{label:"Praat met OXOT",href:"/contact"}, secondaryCta:{label:"Ontdek het platform",href:"/conformity-platform"} }
};
writeFileSync("data/conformity_home_en.json", JSON.stringify(en,null,2));
writeFileSync("data/conformity_home_nl.json", JSON.stringify(nl,null,2));
console.log("wrote conformity_home en/nl. steps en:",en.steps.steps.length,"faq en:",en.faq.items.length,"features:",en.featureGrid.features.length);
