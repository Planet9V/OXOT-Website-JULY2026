-- 019_seed_cra_technical_reference_nl.sql
-- Dutch (NL) translation of the CRA technical-reference page. Seeded via db:migrate
...
VALUES ('cra-technical-reference', 'nl', 'CRA — Volledige technische referentie', '[Kaders](/nl/frameworks) › [Cyber Resilience Act](/nl/cra) › Volledige technische referentie
...
_Zie ook: [Cyber Resilience Act overzicht](/nl/cra) · [CRA CE-markeringstrajecten](/nl/cra-ce-marking-pathways) · [CRA Volledige technische referentie](/nl/cra-technical-reference) · [IEC 62443](/nl/iec-62443) · [NIS2](/nl/nis2)_', true, 'Cyber Resilience Act — Volledige technische referentie (Verord. (EU) 2024/2847) | OXOT', 'Een volledige technische referentie voor de EU Cyber Resilience Act (Verordening (EU) 2024/2847): reikwijdte en uitzonderingen, de drieledige productclassificatie, alle essentiële eisen van bijlage I, conformiteitsbeoordelingsmodules, alle acht bijlagen, sancties en de nalevingstijdlijn.', 'Diepgaande technische referentie voor Verordening (EU) 2024/2847 — structuur van de verordening (8 hoofdstukken, 71 artikelen, 8 bijlagen), productclassificatie, essentiële eisen van bijlage I, conformiteitsbeoordeling, CE-markering, sancties en het nalevingsstappenplan.', NULL, 'article', now(), now())
